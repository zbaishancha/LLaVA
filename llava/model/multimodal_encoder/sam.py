...
def create_sam_vit(
    ...
    **kwargs,
    ...
    if ckpt_path:
        ...
        image_encoder.load_state_dict(state_dict_real, strict=False)
...
class SAMVisionTower(nn.Module):
    def __init__(self, vision_tower, delay_load=False):
        ...
        self.vision_tower_name = vision_tower  # clip name, because sam's img process == clip
    ...
    def load_model(self, device_map=None, model_path=None):
        if self.is_loaded:
            ...
            return
        CKPT_PATH = "/mnt/csi-data-aly/shared/public/haozhou/checkpoints/sam/sam_vit_b_01ec64.pth"
        """
        vision_tower_name: /mnt/csi-data-aly/shared/public/haozhou/checkpoints/sam
        """
        self.image_processor = CLIPImageProcessor.from_pretrained(self.vision_tower_name, size=1024)
        self.vision_tower = create_sam_vit(model_name="sam_vit_b", image_size=336, ckpt_path=CKPT_PATH)
...
if __name__ == "__main__":
    ...
    # x.permute(0, 3, 1, 2)
    net = create_sam_vit(model_name="sam_vit_b", image_size=1024, ckpt_path="/mnt/csi-data-aly/shared/public/haozhou/checkpoints/sam/sam_vit_b_01ec64.pth").bfloat16()
    out = net(x)
    print(x.shape, out.shape)
    image_processor = CLIPImageProcessor.from_pretrained("/mnt/csi-data-aly/shared/public/haozhou/checkpoints/sam")
