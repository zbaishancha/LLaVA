...
torchrun --nproc_per_node=8 \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-v1.5-7b-task-pros-of-pro-parallel-connection-cross \
    --exp_name finetune_llava_v1.5_7b_lingoqa_prompts_of_prompt_parallel_connection_cross \
    --num_train_epochs 1 \
