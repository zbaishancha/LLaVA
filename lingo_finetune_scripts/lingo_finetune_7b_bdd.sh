...
torchrun --nproc_per_node=8 \
    ...
    --version v1 \
    --data_path ./playground/data/BDD-X/train_multi.json \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-v1.5-7b-efficient-head-bdd \
    --exp_name finetune_llava_v1.5_7b_lingoqa_efficient_head_bdd \
    --num_train_epochs 1 \
