...
class Mask2FormerPixelDecoderEncoderMultiscaleDeformableAttention(nn.Module):
    ...
    def forward(
        ...
        output = multi_scale_deformable_attention(value.float(), spatial_shapes, sampling_locations.float(), attention_weights.float()).to(dtype=ori_dtype)
