...
torchrun --nproc_per_node=8 \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-v1.5-7b-task-pros-of-pro-mask2former-clip-embeds \
    --exp_name finetune_llava_v1.5_7b_lingoqa_prompts_of_prompt_mask2former_clip_embeds \
    --num_train_epochs 1 \
