...
import jsonlines
import copy
pre_json_file = 'results/checkpoints/llava-v1.5-7b-task-hop-only-mask2former-question.jsonl'
ori_val_file = 'playground/data/LingoQA/val.json'
csv_file_path = 'llava-v1.5-7b-task-hop-only-mask2former-question.csv'
