...
class MSDeformAttnPixelDecoder(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        self.transformer_in_features = ['res3', 'res4', 'res5']  # starting from "res2" to "res5"
        transformer_in_channels = [384, 768, 1536]
        self.transformer_feature_strides = [8, 16, 32]  # to decide extra FPN layers
