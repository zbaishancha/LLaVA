...
torchrun --nproc_per_node=8 \
    ...
    --version v1 \
    --data_path ./playground/data/LingoQA/train_multi_v2.json \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-v1.5-7b-task-pros-of-pro-only-affinity-feature-v1 \
    --exp_name finetune_llava_v1.5_7b_lingoqa_prompts_of_prompt_only_affinity_feature_v1 \
    --num_train_epochs 1 \
