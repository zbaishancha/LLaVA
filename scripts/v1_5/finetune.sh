...
torchrun --nproc_per_node=8 \
    ...
    --pretrain_mm_mlp_adapter ./checkpoints/llava-v1.5-7b-pretrain-qa-vit/mm_projector.bin \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-v1.5-7b-finetune-qa-vit \
    --exp_name finetune_llava_qa_vit \
    --num_train_epochs 1 \
