...
torchrun --nproc_per_node=8 \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-v1.5-7b-task-pros-of-pro-cat-all-feature-mask2former \
    --exp_name finetune_llava_v1.5_7b_lingoqa_prompts_of_prompt_cat_all_feature_mask2former \
    --num_train_epochs 1 \
