...
import jsonlines
import copy
pre_json_file = 'results/checkpoints/llava-v1.5-7b-task-pros-of-pro-only-create-dinov2-feature.jsonl'
ori_val_file = 'playground/data/LingoQA/val.json'
csv_file_path = 'llava-v1.5-7b-task-pros-of-pro-only-create-dinov2-feature.csv'
